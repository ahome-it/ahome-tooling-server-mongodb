...
package com.ait.tooling.server.mongodb.test
...
class BasicTestsSpecification extends ServerCoreSpecification implements CoreGroovyTrait
{
    def setupSpec()
    {        
        TestingOps.setupServerCoreDefault(["classpath:/com/ait/tooling/server/mongodb/test/ApplicationContext.xml", "classpath:/com/ait/tooling/server/core/config/CoreApplicationContext.xml"])
    }
